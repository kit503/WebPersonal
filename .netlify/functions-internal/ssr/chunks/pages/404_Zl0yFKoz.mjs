...
/* empty css                           */
import { A as AstroError, c as InvalidImageService, d as ExpectedImageOptions, E as ExpectedImage, F as FailedToFetchRemoteImageDimensions, e as createAstro, f as createComponent, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes, i as defineScriptVars, j as renderComponent, k as renderHead, l as renderSlot } from '../astro_4pWy3QZG.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                           */
import { i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_Bibx8e28.mjs';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_Bibx8e28.mjs'
    ).then(n => n.s).catch((e) => {
...
}, "D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/node_modules/astro/components/Image.astro", void 0);
...
}, "D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/node_modules/astro/components/Picture.astro", void 0);

const imageConfig = {"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":[],"remotePatterns":[]};
					new URL("file:///D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/dist/");
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer class="footer footer-center block mb-5 pt-10"> <div class="inline opacity-75">
Developed by <a href="https://manuelernestog.github.io" target="_blank" class="font-bold">Manuel Ernesto</a> using
<!-- Thanks for using this template. You can keep this line to support my work :) --> <a href="https://astrofy-template.netlify.app/" target="_blank" class="font-bold">Astrofy Template ⚡️</a> </div> <div class="inline opacity-75">
Editado por <a href="https://github.com/kit503" target="_blank" class="font-bold">Manuel De la Cruz</a> </div> <div class="pb-2">
&copy; ${today.getFullYear()} Manuel Ernesto
</div> </footer> `;
}, "D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/src/components/Footer.astro", void 0);
...
const $$SideBarMenu = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(["", '<ul class="menu grow shrink menu-md overflow-y-auto"> <li><a class="py-3 text-base" id="home" href="/">Inicio</a></li> <!-- <li><a class="py-3 text-base" id="projects" href="/projects">Proyectos</a></li> --> <!-- <li><a class="py-3 text-base" id="blog" href="/blog/">Blog</a></li> --> <li><a class="py-3 text-base" id="cv" href="/cv">CV</a></li> </ul> <script>(function(){', "\nconst activeItemElem = document.getElementById(sideBarActiveItemID);\nactiveItemElem && activeItemElem.classList.add(activeClass);\n})();<\/script>"])), maybeRenderHead(), defineScriptVars({ sideBarActiveItemID, activeClass }));
}, "D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/src/components/SideBarMenu.astro", void 0);
...
}, "D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/src/components/SideBar.astro", void 0);
...
}, "D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/node_modules/astro/components/ViewTransitions.astro", void 0);
...
}, "D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/src/layouts/BaseLayout.astro", void 0);

const $$Astro = createAstro("https://astrofy-template.netlify.app");
const $$404 = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$404;
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "404: Not Found", "includeSidebar": false }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="text-center"> <h1 class="text-9xl font-bold mb-4">🏝</h1> <h1 class="text-9xl font-bold mb-2">404</h1> <h3 class="text-2xl">La página que buscas no existe.</h3> <a class="btn btn-accent mt-9" href="/">Inicio</a> </div> ` })}`;
}, "D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/src/pages/404.astro", void 0);

const $$file = "D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/src/pages/404.astro";
const $$url = "/404";
