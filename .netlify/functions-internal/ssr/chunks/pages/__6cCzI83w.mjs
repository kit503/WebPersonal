/* empty css                           */
import { e as createAstro, f as createComponent, r as renderTemplate, m as maybeRenderHead, h as addAttribute, j as renderComponent, A as AstroError, n as UnknownContentCollectionError, o as renderUniqueStylesheet, p as renderScriptElement, q as createHeadAndContent, u as unescapeHTML, t as Fragment } from '../astro_4pWy3QZG.mjs';
import 'kleur/colors';
import { $ as $$Image, a as $$BaseLayout } from './404_Zl0yFKoz.mjs';
...
}, "D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/src/components/HorizontalCard.astro", void 0);
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    let entries = [];
    if (!Object.assign({"BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://astrofy-template.netlify.app", "ASSETS_PREFIX": undefined}, { Path: process.env.Path })?.DEV && cacheEntriesByCollection.has(collection)) {
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/post1.md": () => import('../post1_Bg5q6i59.mjs'),"/src/content/blog/post2.md": () => import('../post2_CYT-Lr2u.mjs'),"/src/content/blog/post3.md": () => import('../post3_BhNkY96T.mjs')});
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/post1.md": () => import('../post1_CYqqTWMK.mjs'),"/src/content/blog/post2.md": () => import('../post2_DQneZp9p.mjs'),"/src/content/blog/post3.md": () => import('../post3_DG_ABb4a.mjs')});
...
Entradas Antiguas${" "} <svg class="h-6 w-6 fill-current md:h-8 md:w-8" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"> ${" "} <path d="M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z"></path> </svg> </a>` : renderTemplate`<div></div>`} </div> ` })}`;
}, "D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/src/pages/blog/[...page].astro", void 0);

const $$file$1 = "D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/src/pages/blog/[...page].astro";
...
}, "D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/src/components/HorizontalShopItem.astro", void 0);
...
}, "D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/src/pages/store/[...page].astro", void 0);

const $$file = "D:/Documentos/Manuel/Otros/Proyectos/WebPersonal/astrofy/src/pages/store/[...page].astro";
